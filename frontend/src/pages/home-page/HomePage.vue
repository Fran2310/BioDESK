<template class="home-page">
    ...
    <div class="flex justify-center upper-part">
        ...
        <div class="lab-details">
            <p class="text-5xl text-details"> Laboratorio de Pruebas </p>
                ...
                <div class="submenu">
                    ...
                    <transition leave-active-class="slideup-anim" enter-active-class="slidedown-anim">
                        <div class="show-options">
                            <p class="text-box italic" style="cursor: pointer" v-if="showOptions" @click="toggleOptions"> Mostrar más... </p>
                            <p class="text-box italic" style="cursor: pointer" v-if="!showOptions" @click="toggleOptions"> Mostrar menos... </p>
                            <p class="text-box slideup-anim font-semibold" style="cursor: pointer" @click="goToPatients" v-if="!showOptions"> - Pacientes </p>
                            <p class="text-box slideup-anim font-semibold" style="cursor: pointer" @click="goToMedRecords" v-if="!showOptions"> - Historial médico </p>
                            <p class="text-box slideup-anim font-semibold" style="cursor: pointer" @click="goToTestReq" v-if="!showOptions"> - Solicitud de prueba </p>
                        </div>
                    </transition>
                </div>
