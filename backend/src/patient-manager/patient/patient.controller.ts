import { Controller, Get, Post, Body, Param, Delete, Patch, Headers, Request, Query, ParseIntPipe, ParseBoolPipe } from '@nestjs/common';
...
export class PatientController {
  ...
  @CheckAbility(
    { actions: 'create', subject: 'Patient' },
  )
  create(
  ...
  @Patch('update')
  @ApiOperation({ summary: 'Actualizar datos de un paciente de un laboratorio' })
  @ApiQuery({
    name: 'patientId',
    required: true,
    type: String,
  ...
  @CheckAbility(
    { actions: 'update', subject: 'Patient' },
  )
  update(
    @Query('patientId') patientId: number,
    ...
    return this.patientService.updatePatient(+labId, +patientId, dto, performedByUserUuid);
  }
  ...
  @CheckAbility(
    { actions: 'delete', subject: 'Patient' },
  )
  @Delete('delete')
  delete(
    @Query('patientId') patientId: number,
    ...
    return this.patientService.deletePatient(+labId, +patientId, performedByUserUuid);
  }
}