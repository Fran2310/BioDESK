...
export class LabService {
    ...
    async selectedLab(uuid: string, labId: number) {
        if (!labId) {
            throw new BadRequestException("El id del laboratorio debe estar definido")
        }
        ...
        if (lab) {
            ...
            throw new ForbiddenException("El usuario no tiene acceso al laboratorio indicado")
        }
    }
